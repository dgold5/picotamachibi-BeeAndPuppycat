...
tones = {
    ...
    'C9':8372,'C#9':8870,'D9':9397,'D#9':9956,'E9':10548,'F9':11175,'F#9':11840,'G9':12544,'G#9':13290,'A9':14080,'A#9':14917,'B9':1580
}

class buzzer:
    def __init__(self, pin=None, duty=2512, duration=0.03):
        self.pin=pin
        self.duty=duty
        self.duration=duration

    def buzz(self, freq=tones['C6']):
        pwm = PWM(self.pin)
        pwm.freq(freq)
